...
export class CategoryServiceProxy {
     ...
     * @return Success
     */
    update(body: CreateCategoryDto | undefined): Observable<CategoryDto> {
...
export class ProductServiceProxy {
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, shopId: number | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ProductDtoPagedResultDto> {
...
export class ShopServiceProxy {
     ...
     * @return Success
     */
    create(body: CreateShopDto | undefined): Observable<ShopDto> {
        let url_ = this.baseUrl + "/api/services/app/Shop/Create";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ShopDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ShopDto>><any>_observableThrow(response_);
        }));
    }

    protected processCreate(response: HttpResponseBase): Observable<ShopDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<ShopDto>(<any>null);
    }
     ...
     * @return Success
     */
    update(body: CreateShopDto | undefined): Observable<ShopDto> {
        let url_ = this.baseUrl + "/api/services/app/Shop/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<ShopDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<ShopDto> {
        let url_ = this.baseUrl + "/api/services/app/Shop/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
    ...
    protected processGet(response: HttpResponseBase): Observable<ShopDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ShopDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Shop/GetAll?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&"; 
    ...
    protected processGetAll(response: HttpResponseBase): Observable<ShopDtoPagedResultDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Shop/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
